            ...
            for region in region_names:
                try:
                    ...
                    try:
                        ...
                        inspector_dict = inspector_client.list_assessment_targets()
                        inspector_dict['account_id'] = session_name
                        temp_list.append(inspector_dict)
                    except Exception as e:
                        print(e)
                except Exception as e:
                    print(e)
        with open('inspector_arns_targets.json', 'w') as f:
...
if __name__ == '__main__':
    ...
    parser = Parser()
    df_dict = parser.process(response, 'inspector_arns')
