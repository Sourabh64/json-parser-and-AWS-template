                ...
                try:
                    ...
                    try:
                        ...
                        for region in ec2_regions:
                            ...
                            ec2_security_group = ec2.describe_security_group_rules()
                            ec2_security_group['account_id'] = session_name
                            temp_list.append(ec2_security_group)
                            while 'NextToken' in ec2_security_group:
                                ec2_security_group = ec2.describe_security_group_rules(NextToken=ec2_security_group['NextToken'])
                                ec2_security_group['account_id'] = session_name
                                temp_list.append(ec2_security_group)
...
if __name__ == '__main__':
    ...
    parser = Parser()
    df_dict = parser.process(response, 'sg_rules')
