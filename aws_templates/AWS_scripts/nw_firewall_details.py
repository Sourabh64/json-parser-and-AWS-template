            ...
            for region in region_names:
                try:
                    ...
                    try:
                        ...
                        for nw_fw in nw_firewall_dict['Firewalls']:
                            firewall_arn = nw_fw['FirewallArn']
                            nw_fw_response = nw_client.describe_firewall(FirewallArn=firewall_arn)
                    ...
                    print(e)
        with open('nw_fw_details.json', 'w') as f:
...
if __name__ == '__main__':
    ...
    parser = Parser()
    df_dict = parser.process(response, 'nw_firewall')
